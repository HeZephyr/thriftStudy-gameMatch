...
uint32_t Save_save_data_args::read(::apache::thrift::protocol::TProtocol* iprot) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          xfer += iprot->readI32(this->palyer2_id);
          this->__isset.palyer2_id = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        break;
...
uint32_t Save_save_data_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("palyer2_id", ::apache::thrift::protocol::T_I32, 4);
  xfer += oprot->writeI32(this->palyer2_id);
  xfer += oprot->writeFieldEnd();
...
int32_t SaveClient::save_data(const std::string& username, const std::string& password, const int32_t player1_id, const int32_t palyer2_id)
{
  send_save_data(username, password, player1_id, palyer2_id);
  return recv_save_data();
}

void SaveClient::send_save_data(const std::string& username, const std::string& password, const int32_t player1_id, const int32_t palyer2_id)
{
  int32_t cseqid = 0;
...
void SaveProcessor::process_save_data(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->save_data(args.username, args.password, args.player1_id, args.palyer2_id);
...
int32_t SaveConcurrentClient::save_data(const std::string& username, const std::string& password, const int32_t player1_id, const int32_t palyer2_id)
{
  int32_t seqid = send_save_data(username, password, player1_id, palyer2_id);
  return recv_save_data(seqid);
}

int32_t SaveConcurrentClient::send_save_data(const std::string& username, const std::string& password, const int32_t player1_id, const int32_t palyer2_id)
{
